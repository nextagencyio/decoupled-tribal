...
export const metadata: Metadata = {
  title: 'Events | Red Mesa Tribal Nation',
      ...
      <section className="relative bg-primary-900 text-white py-24 md:py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center pt-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-serif mb-6">Events</h1>
            <p className="text-xl text-primary-100 max-w-3xl mx-auto">Explore our events.</p>
          </div>
        </div>
      </section>
