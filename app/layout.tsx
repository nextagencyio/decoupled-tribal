...
export const metadata: Metadata = {
  ...
  description: 'The Clearwater Band of Ojibwe is a sovereign tribal nation dedicated to preserving our cultural heritage, strengthening our community, and building a prosperous',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
